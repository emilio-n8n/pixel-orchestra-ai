...
export const CATALOG: DirectorModel[] = [
  ...
  { id: "opencode-go/minimax-m3", provider: "opencode-go", modelId: "minimax-m3", label: "MiniMax M3", capabilities: ["chat"] },
  { id: "opencode-go/minimax-m2.7", provider: "opencode-go", modelId: "minimax-m2.7", label: "MiniMax M2.7", capabilities: ["chat"] },
  { id: "opencode-go/minimax-m2.5", provider: "opencode-go", modelId: "minimax-m2.5", label: "MiniMax M2.5", capabilities: ["chat"] },
  ...
  { id: "opencode-go/longcat-2.0", provider: "opencode-go", modelId: "longcat-2.0", label: "Longcat 2.0", capabilities: ["chat"] },
  { id: "opencode-go/kimi-k2.5", provider: "opencode-go", modelId: "kimi-k2.5", label: "Kimi K2.5", capabilities: ["chat"] },
  { id: "opencode-go/glm-5.2", provider: "opencode-go", modelId: "glm-5.2", label: "GLM-5.2", capabilities: ["chat"] },
  { id: "opencode-go/glm-5.3-flash", provider: "opencode-go", modelId: "glm-5.3-flash", label: "GLM-5.3 Flash", capabilities: ["chat"] },
  { id: "opencode-go/glm-5.3", provider: "opencode-go", modelId: "glm-5.3", label: "GLM-5.3", capabilities: ["chat"] },
  { id: "opencode-go/glm-5.1", provider: "opencode-go", modelId: "glm-5.1", label: "GLM-5.1", capabilities: ["chat"] },
  { id: "opencode-go/glm-5", provider: "opencode-go", modelId: "glm-5", label: "GLM-5", capabilities: ["chat"] },
  ...
  { id: "opencode-go/deepseek-v4-flash-vision-exp", provider: "opencode-go", modelId: "deepseek-v4-flash-vision-exp", label: "DeepSeek V4 Flash Vision Exp", capabilities: ["chat"] },
  { id: "opencode-go/qwen3.7-max", provider: "opencode-go", modelId: "qwen3.7-max", label: "Qwen3.7 Max", capabilities: ["chat"] },
  { id: "opencode-go/qwen3.8-max", provider: "opencode-go", modelId: "qwen3.8-max", label: "Qwen3.8 Max", capabilities: ["chat"] },
  { id: "opencode-go/qwen3.8-flash", provider: "opencode-go", modelId: "qwen3.8-flash", label: "Qwen3.8 Flash", capabilities: ["chat"] },
  { id: "opencode-go/qwen3.7-plus", provider: "opencode-go", modelId: "qwen3.7-plus", label: "Qwen3.7 Plus", capabilities: ["chat"] },
  { id: "opencode-go/qwen3.6-plus", provider: "opencode-go", modelId: "qwen3.6-plus", label: "Qwen3.6 Plus", capabilities: ["chat"] },
  { id: "opencode-go/qwen3.5-plus", provider: "opencode-go", modelId: "qwen3.5-plus", label: "Qwen3.5 Plus", capabilities: ["chat"] },
  { id: "opencode-go/mimo-v2-pro", provider: "opencode-go", modelId: "mimo-v2-pro", label: "MiMo-V2 Pro", capabilities: ["chat"] },
  { id: "opencode-go/mimo-v2-omni", provider: "opencode-go", modelId: "mimo-v2-omni", label: "MiMo-V2 Omni", capabilities: ["chat"] },
  { id: "opencode-go/mimo-v2.5-pro", provider: "opencode-go", modelId: "mimo-v2.5-pro", label: "MiMo-V2.5-Pro", capabilities: ["chat"] },
  { id: "opencode-go/mimo-v2.5", provider: "opencode-go", modelId: "mimo-v2.5", label: "MiMo-V2.5", capabilities: ["chat"] },
  { id: "opencode-go/hy4-preview", provider: "opencode-go", modelId: "hy4-preview", label: "HY4 Preview", capabilities: ["chat"] },
  { id: "opencode-go/hy3", provider: "opencode-go", modelId: "hy3", label: "HY3", capabilities: ["chat"] },
  { id: "opencode-go/hy3-preview", provider: "opencode-go", modelId: "hy3-preview", label: "HY3 Preview", capabilities: ["chat"] },
  { id: "opencode-go/gpt-5.6-luna", provider: "opencode-go", modelId: "gpt-5.6-luna", label: "GPT-5.6 Luna", capabilities: ["chat"] },
  { id: "opencode-go/grok-4.5", provider: "opencode-go", modelId: "grok-4.5", label: "Grok 4.5", capabilities: ["chat"] },
  { id: "opencode-go/grok-4.6", provider: "opencode-go", modelId: "grok-4.6", label: "Grok 4.6", capabilities: ["chat"] },
  { id: "opencode-go/omen-alpha", provider: "opencode-go", modelId: "omen-alpha", label: "Omen Alpha", capabilities: ["chat"] },
